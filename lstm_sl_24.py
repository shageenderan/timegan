...
#%%
# tSNE AND PCA
tSNE_Analysis (dataX, dataX_hat, os.path.join("hyperparameter_tests/lstm_sl_24", data_name+"_tSNE.png"))
PCA_Analysis (dataX, dataX_hat, os.path.join("hyperparameter_tests/lstm_sl_24", data_name+"_PCA.png"))
...
#%%
# Save outputs
np.save(os.path.join("hyperparameter_tests/lstm_sl_24", "soro_synthetic_data"), dataX_hat)

with open(os.path.join("hyperparameter_tests/lstm_sl_24", "synthetic_dpScore.txt"), "w+") as f:
...
for i in range(len(data)):
  ...
  pyplot.savefig(os.path.join("hyperparameter_tests/lstm_sl_24", titles))
# %%
