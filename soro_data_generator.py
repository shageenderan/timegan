...
#%%
# tSNE AND PCA
tSNE_Analysis (dataX, dataX_hat, os.path.join("hyperparameter_tests", data_name+"_tSNE.png"))
PCA_Analysis (dataX, dataX_hat, os.path.join("hyperparameter_tests", data_name+"_PCA.png"))
...
#%%
# Save outputs
np.save(os.path.join("hyperparameter_tests", "soro_synthetic_data"), dataX_hat)

with open("synthetic_dpScore.txt", "w+") as f:
...
for i in range(len(data)):
  ...
  pyplot.savefig(os.path.join("hyperparameter_tests", titles))
# %%
